...
@section('title', __('cruds.actions.Add').__('cruds.user_vehicle.title_singular'))
    ...
    <div class="container py-4">
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <x-form method="POST" action="{{ route('frontend.user.profile.vehicle.store') }}">
                    <x-frontend.card>
                        <div class="d-flex justify-content-between">
                            <x-slot name="header">
                                @lang('global.actions.Add') @lang('cruds.user_vehicle.title_singular')
                            </x-slot>
